                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm py-3 px-4">
                        ...
                        <form class="row gy-3" action="{{url('register')}}" method="post">
                            @csrf
                            <div class="col-12">
                                <label for="nameInp" class="form-label">Имя</label>
                            ...
                            <div class="col-12">
                                <label for="passInp" class="form-label">Пароль</label>
                                <input type="password" class="form-control" id="passInp" name="password">
                                @error('password')<small class="text-danger">{{$message}}</small>@enderror
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100" type="submit">Зарегистрировать</button>
                            </div>
                        </form>
